...
class MainViewController: UIViewController {
    ...
    @IBOutlet var gradientView: ASGradientView!
    ...
    func initialiseCarioca() {
        if let controller = storyboard?.instantiateViewController(withIdentifier: "DemoMenu")
    ...
    override func viewWillTransition(to _: CGSize, with coordinator: UIViewControllerTransitionCoordinator) {
        coordinator.animateAlongsideTransition(in: view, animation: nil, completion: { [weak self] _ in
...
extension MainViewController: CariocaDelegate {
    func cariocamenu(_: CariocaMenu, didSelect item: CariocaMenuItem, at index: Int) {
    ...
    func cariocamenu(_: CariocaMenu, willOpenFromEdge edge: UIRectEdge) {
