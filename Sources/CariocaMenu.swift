...
public class CariocaMenu: NSObject, CariocaGestureManagerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    public init(controller: CariocaController,
        ...
        self.edges = edges
        container = CariocaMenuContainerView(frame: hostView.frame,
                                             dataSource: controller)
        gestureManager = CariocaGestureManager(hostView: hostView,
    ...
    public func numberOfSections(in _: UITableView) -> Int { return 1 }
